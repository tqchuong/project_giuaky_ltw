...
<main class="main-wrapper">
    <div class="container" id="trangchu">
        ...
        <div class="home-products" id="home-products"><c:forEach var="product" items="${products}">
            <div class="col-product" data-id="${product.ProductID}" data-name="${product.ProductName}">
                <article class="card-product">
                    <div class="card-header">
                        <a href="productDetail.jsp?productID=${product.ProductID}" class="card-image-link">
                    ...
                    <div class="food-info">
                        <div class="card-content">
                            <div class="card-title">
                                <a href="productDetail.jsp?productID=${product.ProductID}" class="card-title-link">${product.ProductName}</a>
                            </div>
                        </div>
