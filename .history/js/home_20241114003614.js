...
// Gắn sự kiện cho fullname để hiển thị menu khi di chuột vào
document.querySelector('.auth-container').addEventListener('mouseover', () => {
    document.getElementById('user-menu').style.display = 'block';
});

document.querySelector('.auth-container').addEventListener('mouseleave', () => {
    document.getElementById('user-menu').style.display = 'none';
});

// Ngăn chuyển trang khi click vào fullname
document.querySelector('.auth-container').addEventListener('click', (event) => {
    event.preventDefault(); // Ngăn chuyển trang
    document.getElementById('user-menu').style.display = 'block';
});

// Ngăn menu đóng khi nhấn vào bên trong menu
