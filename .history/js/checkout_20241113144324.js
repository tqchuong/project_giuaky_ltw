...
function showProductCart() {
    ...
    if (currentUser && currentUser.cart) {
                ...
                listOrderHtml += `
                    <div class="food-total">
                        ...
                        <div class="info-food">
                            ...
                            <div class="price">${vnd(product.price * item.quantity)}</div>
                        </div>
                    </div>`;
            } else {
        ...
        console.error("Không có sản phẩm trong giỏ hàng hoặc không thể truy cập currentUser.");
        listOrder.innerHTML = "<p>Không có sản phẩm nào trong giỏ hàng.</p>";
    }
}
