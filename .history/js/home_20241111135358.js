                    ...
                    <div class="food-info">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="product-buy">
                             <button onclick="orderAndRedirect(${product.id})" class="card-button order-item">
...
function orderAndRedirect(productId) {
    addToCart(productId); // Gọi hàm để thêm sản phẩm vào giỏ hàng
    setTimeout(() => {
        window.location.href = "checkout.html"; // Chuyển hướng đến trang giỏ hàng
    }, 100); // Độ trễ ngắn để đảm bảo thêm vào giỏ hoàn tất trước khi chuyển hướng
}
