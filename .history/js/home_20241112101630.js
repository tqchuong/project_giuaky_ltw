...
function showCategory(category) {
    // Thay đổi nội dung hiển thị tùy theo danh mục
    let content = document.getElementById('content');
    
    switch(category) {
        case 'Trang chủ':
            content.innerHTML = "<h2>Trang chủ</h2><p>Chào mừng bạn đến với trang chủ của chúng tôi.</p>";
            break;
        case 'Sản phẩm':
            content.innerHTML = "<h2>Sản phẩm</h2><p>Chọn một danh mục để xem thông tin chi tiết về sản phẩm.</p>";
            break;
        case 'Gạo':
            content.innerHTML = "<h2>Gạo</h2><p>Thông tin chi tiết về sản phẩm gạo...</p>";
            break;
        case 'Lúa mì':
            content.innerHTML = "<h2>Lúa mì</h2><p>Thông tin chi tiết về sản phẩm lúa mì...</p>";
            break;
        case 'Bắp':
            content.innerHTML = "<h2>Bắp</h2><p>Thông tin chi tiết về sản phẩm bắp...</p>";
            break;
        case 'Cao lương':
            content.innerHTML = "<h2>Cao lương</h2><p>Thông tin chi tiết về sản phẩm cao lương...</p>";
            break;
        case 'Kê':
            content.innerHTML = "<h2>Kê</h2><p>Thông tin chi tiết về sản phẩm kê...</p>";
            break;
        case 'Khác':
            content.innerHTML = "<h2>Khác</h2><p>Thông tin về các sản phẩm khác...</p>";
            break;
        default:
            content.innerHTML = "<p>Không có thông tin.</p>";
    }
}
