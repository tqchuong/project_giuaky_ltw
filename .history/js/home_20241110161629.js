    ...
    let modalHtml = `
        ...
        <div class="modal-body">
            ...
            <div class="product-details">
                ...
                <p class="detail-item"><strong>Nhà sản xuất:</strong> ${product.manufacturer}</p>
                <p class="detail-item"><strong>Gửi từ:</strong> ${product.shipFrom}</p>
            </div>
            <div class="product-reviews">
                <h3>Đánh giá:</h3>
                ${productReviews.map(review => `<div class="review"><strong>${review.customer}</strong>: ${review.comment}</div>`).join('')}
            </div>
        </div>
    `;
...
// Hàm khởi tạo trang với danh sách sản phẩm
