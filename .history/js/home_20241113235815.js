...
// Cập nhật trạng thái đăng nhập và hiển thị thông tin người dùng
function kiemtradangnhap() {
    ...
    if (currentUser) {
        ...
        // Sự kiện hiển thị "Tài khoản của tôi" khi nhấn vào hồ sơ
        authContainer.addEventListener('click', (event) => {
            event.stopPropagation();
            showAccountInfo(); // Hiển thị "Tài khoản của tôi"
        });
